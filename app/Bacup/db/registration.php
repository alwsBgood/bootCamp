...
$db_user = "allinsol_bc"; // Логин БД
$db_password = "pbcyrgh7 "; // Пароль БД
$database = "allinsol_bc"; // БД
...
$name = getVar('entry_1867721116');
$phone = getVar('entry_1757140399');
$email = getVar('entry_763954787');
  
if (empty($name) && empty($phone) && empty($email)) {
  $name = getVar('entry_156009651');
  $phone = getVar('entry_563143615');
